...
const ChaptersList = ({ items, onReorder, onEdit }: Props) => {
  ...
  // don't allow drag and drop functionalty on the server side when the component got fetched cuz it will coze an errors
                ...
                {(provided) => (
                  <div
                    className={cn(
                      ...
                      chapter.published && "border-sky-200 bg-sky-100 text-sky-700",
                    )}
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        chapter.published && "border-r-sky-200 hover:bg-sky-200",
                      )}
                    ...
                    <div className="ml-auto flex items-center gap-x-2 pr-2">
                      ...
                      <Badge className={cn("bg-slate-500", chapter.published && "bg-sky-700")}>
